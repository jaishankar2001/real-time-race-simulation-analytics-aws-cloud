...
const CERT_PATH = './connect_device_package/backend-server.cert.pem';
const KEY_PATH = './connect_device_package/backend-server.private.key';
const CA_PATH = './connect_device_package/root-CA.crt';

// AWS IoT Endpoint and Topic
const AWS_IOT_ENDPOINT = 'a334ytetkt18c2-ats.iot.us-east-1.amazonaws.com'; // replace with your AWS IoT endpoint
