...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a334ytetkt18c2-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert backend-server.cert.pem --key backend-server.private.key --client_id basicPubSub --topic sdk/test/python --count 0