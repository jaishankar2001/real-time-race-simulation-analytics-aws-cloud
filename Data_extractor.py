...
client_id = 'disconnector12'  # Replace with your client ID
endpoint = 'a334ytetkt18c2-ats.iot.us-east-1.amazonaws.com'  # Replace with your IoT endpoint
root_ca_path = './connect_device_package/root-CA.crt'
private_key_path = './connect_device_package/backend-server.private.key'
certificate_path = './connect_device_package/backend-server.cert.pem'
# root_ca_path = './connect_device_package/root-CA.crt'
# private_key_path = './connect_device_package/private.key'
# certificate_path = './connect_device_package/certificate.pem'
